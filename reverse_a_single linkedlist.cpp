...
SinglyLinkedListNode* reverse(SinglyLinkedListNode* llist) {
     SinglyLinkedListNode* previous = NULL, *current;
 
    // * Looping while head is not NULL
    while(llist!=NULL) {
 
        /*
        *   Pointing current to head.
        *   Pointing head to the next node.
        *   Pointing the next of current to previous.
        *   Pointing previous to current
        */
        current = llist;
        llist = llist->next;
